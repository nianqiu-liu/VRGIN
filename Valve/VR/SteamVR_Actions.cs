namespace Valve.VR
{
    public class SteamVR_Actions
    {
        ...
        private static void InitializeActionArrays()
        {
            ...
            {
                legacy_emulate_Grip_Press, legacy_emulate_Grip_Touch, legacy_emulate_Grip_2D, legacy_emulate_ApplicationMenu_Press, legacy_emulate_ApplicationMenu_Touch, legacy_emulate_A_Press,
                legacy_emulate_A_Touch, legacy_emulate_Axis0_Press, legacy_emulate_Axis0_Touch, legacy_emulate_Axis0_2D,
                legacy_emulate_Axis1_Press, legacy_emulate_Axis1_Touch, legacy_emulate_Axis1_2D, legacy_emulate_Axis2_Press, legacy_emulate_Axis2_Touch, legacy_emulate_Axis2_2D, legacy_emulate_Axis3_Press,
                legacy_emulate_Axis3_Touch, legacy_emulate_Axis3_2D, legacy_emulate_Axis4_Press,
            ...
            {
                legacy_emulate_Grip_Press, legacy_emulate_Grip_Touch, legacy_emulate_ApplicationMenu_Press, legacy_emulate_ApplicationMenu_Touch, legacy_emulate_A_Press, legacy_emulate_A_Touch,
                legacy_emulate_Axis0_Press, legacy_emulate_Axis0_Touch, legacy_emulate_Axis1_Press, legacy_emulate_Axis1_Touch,
                legacy_emulate_Axis2_Press, legacy_emulate_Axis2_Touch, legacy_emulate_Axis3_Press, legacy_emulate_Axis3_Touch, legacy_emulate_Axis4_Press, legacy_emulate_Axis4_Touch,
                legacy_emulate_System_Press, legacy_emulate_System_Touch
            };
            SteamVR_Input.actionsSingle = new SteamVR_Action_Single[2] { legacy_emulate_Axis1_1D, legacy_emulate_Grip_1D };
            SteamVR_Input.actionsVector2 = new SteamVR_Action_Vector2[6]
                { legacy_emulate_Grip_2D, legacy_emulate_Axis0_2D, legacy_emulate_Axis1_2D, legacy_emulate_Axis2_2D, legacy_emulate_Axis3_2D, legacy_emulate_Axis4_2D };
