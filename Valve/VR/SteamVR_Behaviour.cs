...
namespace Valve.VR
{
    public class SteamVR_Behaviour : MonoBehaviour
    {
        ...
        {
            if (!(_instance == null) || initializing) return;
            initializing = true;
            GameObject gameObject = null;
            if (forceUnityVRToOpenVR) forcingInitialization = true;
            var steamVR_Render = FindObjectOfType<SteamVR_Render>();
            if (steamVR_Render != null) gameObject = steamVR_Render.gameObject;
            var steamVR_Behaviour = FindObjectOfType<SteamVR_Behaviour>();
            if (steamVR_Behaviour != null) gameObject = steamVR_Behaviour.gameObject;
            if (gameObject == null)
            {
                var gameObject2 = new GameObject("[SteamVR]");
            ...
            else
            {
                ...
                if (steamVR_Behaviour == null) steamVR_Behaviour = gameObject.AddComponent<SteamVR_Behaviour>();
                ...
                else
                {
                    ...
                    if (steamVR_Behaviour.steamvr_render == null) steamVR_Behaviour.steamvr_render = gameObject.AddComponent<SteamVR_Render>();
                }

                _instance = steamVR_Behaviour;
            }

            if (_instance != null && _instance.doNotDestroy) DontDestroyOnLoad(_instance.transform.root.gameObject);
            initializing = false;
        }
        ...
        {
            isPlaying = true;
            if (initializeSteamVROnAwake && !forcingInitialization) InitializeSteamVR(false);
        }
        ...
        {
            if (OpenVR.Input != null) SteamVR_Input.FixedUpdate();
        }

        protected void LateUpdate()
        {
            if (OpenVR.Input != null) SteamVR_Input.LateUpdate();
        }

        protected void Update()
        {
            if (OpenVR.Input != null) SteamVR_Input.Update();
        }
