...
namespace Valve.VR
{
    public class SteamVR_Behaviour_Vector2 : MonoBehaviour
    {
        ...
        {
            if (onUpdate != null) onUpdate.Invoke(this, fromSource, newAxis, newDelta);
            if (onUpdateEvent != null) onUpdateEvent(this, fromSource, newAxis, newDelta);
        }
        ...
        {
            if (onChange != null) onChange.Invoke(this, fromSource, newAxis, newDelta);
            if (onChangeEvent != null) onChangeEvent(this, fromSource, newAxis, newDelta);
        }
        ...
        {
            if (onAxis != null) onAxis.Invoke(this, fromSource, newAxis, newDelta);
            if (onAxisEvent != null) onAxisEvent(this, fromSource, newAxis, newDelta);
        }

        public string GetLocalizedName(params EVRInputStringBits[] localizedParts)
        {
            if (vector2Action != null) return vector2Action.GetLocalizedOriginPart(inputSource, localizedParts);
            return null;
        }
    }
}
