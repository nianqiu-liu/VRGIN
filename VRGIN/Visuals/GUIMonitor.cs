...
namespace VRGIN.Visuals
{
	public class GUIMonitor : GUIQuad
	{
		...
		public void Rebuild()
		{
			...
			try
			{
				base.transform.localPosition = new Vector3(base.transform.localPosition.x, VR.Settings.OffsetY, base.transform.localPosition.z);
				base.transform.localScale = Vector3.one * VR.Settings.Distance;
				base.transform.localRotation = Quaternion.Euler(0f, VR.Settings.Rotation, 0f);
