...
namespace Valve.VR
{
    public class SteamVR_Fade : MonoBehaviour
    {
        ...
        {
            OpenVR.Compositor?.FadeToColor(duration, newColor.r, newColor.g, newColor.b, newColor.a, false);
        }
        ...
        private void OnEnable()
        {
            ...
            {
                fadeMaterial = new Material(UnityHelper.GetShader("Custom/SteamVR_Fade"));
        ...
        private void OnPostRender()
        {
            if (currentColor != targetColor)
            {
                ...
                if (fadeOverlay)
                {
                    ...
                    if (instance != null) instance.alpha = 1f - currentColor.a;
                }
            }
