...
namespace Valve.VR
{
    public class SteamVR_Behaviour_Boolean : MonoBehaviour
    {
        ...
        {
            if (onPressUp != null) onPressUp.Invoke(this, fromSource, false);
            if (onPressUpEvent != null) onPressUpEvent(this, fromSource);
        }

        private void SteamVR_Behaviour_Boolean_OnStateDown(SteamVR_Action_Boolean fromAction, SteamVR_Input_Sources fromSource)
        {
            if (onPressDown != null) onPressDown.Invoke(this, fromSource, true);
            if (onPressDownEvent != null) onPressDownEvent(this, fromSource);
        }

        private void SteamVR_Behaviour_Boolean_OnState(SteamVR_Action_Boolean fromAction, SteamVR_Input_Sources fromSource)
        {
            if (onPress != null) onPress.Invoke(this, fromSource, true);
            if (onPressEvent != null) onPressEvent(this, fromSource);
        }
        ...
        {
            if (onUpdate != null) onUpdate.Invoke(this, fromSource, newState);
            if (onUpdateEvent != null) onUpdateEvent(this, fromSource, newState);
        }
        ...
        {
            if (onChange != null) onChange.Invoke(this, fromSource, newState);
            if (onChangeEvent != null) onChangeEvent(this, fromSource, newState);
        }

        public string GetLocalizedName(params EVRInputStringBits[] localizedParts)
        {
            if (booleanAction != null) return booleanAction.GetLocalizedOriginPart(inputSource, localizedParts);
            return null;
        }
    }
}
