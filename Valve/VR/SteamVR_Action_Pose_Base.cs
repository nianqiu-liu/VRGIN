...
namespace Valve.VR
{
    ...
    public abstract class SteamVR_Action_Pose_Base<SourceMap, SourceElement> : SteamVR_Action_In<SourceMap, SourceElement>, ISteamVR_Action_Pose, ISteamVR_Action_In_Source, ISteamVR_Action_Source
        where SourceMap : SteamVR_Action_Pose_Source_Map<SourceElement>, new() where SourceElement : SteamVR_Action_Pose_Source, new()
    {
        ...
        {
            for (var i = 0; i < SteamVR_Input.actionsPose.Length; i++) SteamVR_Input.actionsPose[i].sourceMap.SetTrackingUniverseOrigin(newOrigin);
            for (var j = 0; j < SteamVR_Input.actionsSkeleton.Length; j++) SteamVR_Input.actionsSkeleton[j].sourceMap.SetTrackingUniverseOrigin(newOrigin);
        }
