...
namespace Valve.VR
{
    ...
    {
        [SerializeField] private string actionSetPath;

        [NonSerialized] protected SteamVR_ActionSet_Data setData;
        ...
        public SteamVR_Action[] allActions
        {
            get
            {
                if (!initialized) Initialize(false, true);
        ...
        {
            if (originToHighlight == null) return SteamVR_Input.ShowBindingHints(this);
        ...
        public override bool Equals(object other)
        {
            if (other == null)
            {
                if (string.IsNullOrEmpty(actionSetPath)) return true;
                return false;
            }

            if (this == other) return true;
            if (other is SteamVR_ActionSet) return Equals((SteamVR_ActionSet)other);
            return false;
        }

        public override int GetHashCode()
        {
            if (actionSetPath == null) return 0;
        ...
        public static bool operator ==(SteamVR_ActionSet set1, SteamVR_ActionSet set2)
        {
            var flag = (object)set1 == null || string.IsNullOrEmpty(set1.actionSetPath) || set1.GetActionSetData() == null;
            var flag2 = (object)set2 == null || string.IsNullOrEmpty(set2.actionSetPath) || set2.GetActionSetData() == null;
        ...
        {
            if (setData != null && setData.fullPath != actionSetPath) setData = SteamVR_Input.GetActionSetDataFromPath(actionSetPath);
